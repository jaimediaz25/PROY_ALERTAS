...
<head>
  ...
  <title>Monitor de Sensores de Gas</title>
  ...
  <style>
    :root {
      --primary-color: #dc1515;  /* Rojo principal para diseño */
...
<body>
  <div class="header">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center flex-wrap">
        <div>
          <h1><i class="fas fa-gas-pump me-2"></i>Monitor de Sensores</h1>
          <p>Visualización en tiempo real de las lecturas de gas</p>
        </div>
    ...
    <div class="sensor-card">
      <div class="sensor-header">
        <div>
          <h2 class="sensor-title">
            <i class="fas fa-gas-pump me-2"></i>{{ $sensor['tipo'] }} - {{ $sensor['ubicacion'] }}
          </h2>
      ...
      <div class="sensor-body">
        ...
        <div class="stats-container">
          ...
          @endphp
          <div class="stat-box">
            <div class="stat-value">{{ number_format($lastValue, 1) }}</div>
            <div class="stat-label">Actual (ppm)</div>
          </div>
          <div class="stat-box">
          ...
          <div class="stat-box">
            <div class="stat-value">{{ number_format($minValue, 1) }}</div>
            <div class="stat-label">Mínimo</div>
          </div>
          <div class="stat-box">
            <div class="stat-value">{{ number_format($avgValue, 1) }}</div>
  ...
  <script>
    ...
    // Se conserva el degradado azul únicamente para la gráfica
    const gradient{{ $sensor['_id'] }} = ctx{{ $sensor['_id'] }}.createLinearGradient(0, 0, 0, 400);
    gradient{{ $sensor['_id'] }}.addColorStop(0, 'rgba(54, 162, 235, 0.3)');
    gradient{{ $sensor['_id'] }}.addColorStop(1, 'rgba(54, 162, 235, 0)');
    ...
    new Chart(ctx{{ $sensor['_id'] }}, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: '#36a2eb', // Color azul para la línea de la gráfica
